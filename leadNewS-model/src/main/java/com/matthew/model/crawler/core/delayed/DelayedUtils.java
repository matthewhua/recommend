package com.matthew.model.crawler.core.delayed;

import com.matthew.model.crawler.core.callback.ConcurrentCallBack;
import com.matthew.model.crawler.core.callback.DelayedCallBack;
...
public class DelayedUtils
{
	...
	public synchronized static ConcurrentCallBack getConcurrentFilter(final long time)
	{
		...
		{
			@Override public boolean filter()
			{
				boolean flag = false;
				//数据库初始化
