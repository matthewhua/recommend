package com.matthew.behavior.service.impl;
...
import com.matthew.model.mappers.app.ApBehaviorEntryMapper;
import com.matthew.model.mappers.app.ApShowBehaviorMapper;
...
public class AppShowBehaviorServiceImpl implements AppShowBehaviorService
{
	...
	@Override public ResponseResult saveShowBehavior(ShowBehaviorDto dto)
	{
		...
		//根据行为实体id 和文章列表id 查询app行为表 ap_show_behavior
